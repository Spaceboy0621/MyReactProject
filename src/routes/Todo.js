  ...
  return (
    <>
      <div className="flex py-4">
        <Link to="/todoadd" className="w-1/4">
            <button
                    ...
                    <tr key={index}>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          <div className="flex-shrink-0 h-10 w-10">
                            <img className="h-10 w-10 rounded-full" src={todo.image} alt="" />
                          </div>
                          <div className="ml-4">
                            <div className="text-sm font-medium text-gray-900">{todo.title}</div>
                            <div className="text-sm text-gray-500">{todo.during}</div>
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-sm font-medium">
                        <div className="grid gap-3 grid-cols-3">
                          <div>
                            <Link onClick={() => handleEdit(todo.id)} to={`todoedit/${todo.id}`} className="text-indigo-600 hover:text-indigo-900">
                          ...
                          <div>
                            <div onClick={() => handleDel(todo.id)} className="text-indigo-600 hover:text-indigo-900">
                              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
